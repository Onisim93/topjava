...
<section>
    ...
    <form id="filterForm">
        ...
        <button type="button" class="btn btn-primary" onclick="getWithFilter()"><spring:message code="meal.filter"/></button>
        <button type="reset" class="btn btn-secondary" onclick="resetFilterForm()"><spring:message code="common.reset"/></button>
    </form>
    <hr>
